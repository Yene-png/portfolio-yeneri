...
export default function Portfolio() {
  ...
  const projects = [
    {
      ...
      featured: true,
      link: 'https://www.behance.net/gallery/248076043/HogarTech-Identidad-Visual',
      github: '#'
    },
    {
      ...
      technologies: ['Inkscape', 'Gimp', 'Canva', 'Photoshop'],
      featured: false,
      link: 'https://www.behance.net/gallery/248359925/Helados-La-Bendicion-Branding-e-Identidad-Visual'
    },
    {
      title: 'Affinity BPO',
      category: 'Diseño',
      ...
      featured: true,
      link: 'https://www.behance.net/gallery/248697839/Comunicacion-Corporativa-Interna-Affinity-BPO',
      github: '#'
    },
    {
  ...
  {featuredProjects.map((project, index) => (
    ...
    >
      <Card className="overflow-hidden hover:shadow-xl transition-shadow border-[#F297FB] cursor-pointer">
